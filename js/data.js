...
let qnaList = [
  {
    ...
    a: [
      ...
      {
        answer: " 친해지고 싶은데... 먼저 말 걸어주면 좋겠다ㅠㅠ",
        type: [0, 3, 6, 5, 10, 8],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer: " 오 남주 연기 미쳤는데? 스토리 진행도 깔끔해",
        type: [0, 3, 2, 8],
      },
      {
        answer:
          " 남주랑 결혼식은 어디서 하면 좋을까? 아무래도 제주도가 좋겠지? 부케는 영자한테 줘야지~^^",
        type: [1, 6, 5, 10],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer: " (내 재능을 칭찬하다니.. 기분 좋다..ㅎㅎ)",
        type: [1, 3, 2, 10, 8],
      },
      {
        answer:
          " (지금 나랑 싸우자는 거? 내가 과제를 얼마나 열심히 했는데 니가 뭘 알아...)",
        type: [7, 9, 11],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer: " 마감일을 기준으로 기한 내에 끝내기 위해 빠르게 실행한다 ",
        type: [1, 2, 4],
      },
      {
        answer: " 기한 내에 끝내기 위해 시작일부터 정하고 시작한다 ",
        type: [7, 10, 8, 9, 11],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer: " 역시 친구가 최고! 친구와 만나 즐겁게 논다",
        type: [1, 7, 10, 4, 9],
      },
      {
        answer: " 친구는 무슨... 혼자 조용히 집에서 쉰다",
        type: [0, 3, 6, 11],
      },
    ],
  },

  {
    ...
    a: [
      {
        answer:
          " 이전까지 해온 방식이 더 좋지. 이미 보장되어 있는 방법 아닌가?",
        type: [4, 9, 11],
      },
      {
        answer: " 이번엔 새로운 방식으로 해볼까? 이게 더 좋은 방법일지도 몰라",
        type: [0, 3, 6, 10],
      },
    ],
  },
  {
    ...
    a: [
      ...
      {
        answer:
          " 괜찮아ㅠㅠ 다음에 더 열심히 준비해서 시험보면 꼭 붙을 수 있을거야.. 힘내!!",
        type: [2, 4, 9],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer:
          " 4시까지는 숙소에 와야하니까 3시 30분쯤에 미림짬뽕집에서 출발하고...",
        type: [0, 4, 9],
      },
      {
        answer: " 일단 피곤하니까 잠부터 자고 내일 생각해보자!",
        type: [3, 2, 6, 5, 10, 8],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer: " 예이~ 기왕 노는거 적어도 일주일에 3번은 나가서 놀아야지~",
        type: [7, 0, 5, 9],
      },
      {
        answer: " 3번? 한 달에 3번 잡는 것도 부담스러운데...",
        type: [1, 3, 6, 11],
      },
    ],
  },
  ...
  },
  {
    ...
    a: [
      {
        answer: " ㅋㅋㅋ어디가 어떻게 분위기 있는데? 구체적으로 말해봐~",
        type: [1, 4, 9, 11],
      },
      {
        answer: " 아 뭐야 ㅋㅋㅋ 오늘 좀 신경 쓴 보람이 있네 고마워~~",
        type: [7, 0, 3, 6, 10],
      },
    ],
  },
  {
    ...
    a: [
      {
        answer:
          " 가게에 들어가기 직전에 QR 코드를 미리 다 켜둔 상태로 들어간다",
        type: [3, 6, 4, 9],
      },
      {
        answer: " 가게에 들어가고 나면 그제서야 QR 코드를 후다닥 킨다",
        type: [0, 2, 5, 10, 8],
      },
    ],
  },
